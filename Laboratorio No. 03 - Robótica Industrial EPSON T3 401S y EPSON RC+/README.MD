...
flowchart TD
    ...
    %% Estilos para volver invisible el fondo y borde del recuadro del subgraph
    style Paletizado_01 fill:transparent,stroke:#555,stroke-width:1px,stroke-dasharray: 5 5
```
